$(document).ready( function () {
    ...
    $('.btn-table').append(
        ...
        '<a href="' + root + '/admin/pdf/resepsionisuser"class="btn btn-danger ml-3"> Export PDF <i class="fas fa-file-pdf"></i></button></a>'+
        '<a href="' + root + '/admin/excel/resepsionisuser"class="btn btn-success ml-3"> Export Excel <i class="fas fa-file-excel"></i></a>'
    );
