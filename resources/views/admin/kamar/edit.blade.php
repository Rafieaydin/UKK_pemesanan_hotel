            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <select name="tipe_id" value="{{ old('tipe_id') }}" class="form-control @error('tipe_id')
                            ...
                            <option value="{{ $value->id }}" @if (old('tipe_id',$kamar->tipekamar->id) == $value->id)
                                selected
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="jumlah_kamar" value="{{ old('jumlah_kamar',$kamar->jumlah_kamar) }}" class="form-control @error('jumlah_kamar')
                            is-invalid
