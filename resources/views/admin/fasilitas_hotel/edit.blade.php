...
<div class="card">
    ...
    <div class="card-body" class="mt-5">
        <form action="{{ route('admin.fasilitas_hotel.update',$fasilitas_hotel->id) }}" method="POST" enctype="multipart/form-data">
            @method('PATCH')
            @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="nama_fasilitas" value="{{ old('nama_fasilitas',$fasilitas_hotel->nama_fasilitas) }}" class="form-control @error('nama_fasilitas')
                            is-invalid
                        @enderror"
