              ...
              <div class="col-md-7">
                ...
                <form action="{{ route('auth.reset_password') }}" method="POST">
                  ...
                  <div class="form-group first">
                    ...
                    <input type="text"  class="form-control @error('email') is-invalid @enderror" name="email" placeholder="your-email@gmail.com" id="email" value="{{ old('email', request()->email) }}" readonly>
                    @error('email')
                  ...
                  <div class="form-group last mb-3">
                    ...
                    <input type="password" class="form-control  @error('password_confirmation') is-invalid @enderror" name="password_confirmation" placeholder="Konfirmasi Password" id="password_confirmation" value="{{ old('password_confirmation') }}">
