...
<head>
    ...
    <title>Table Data Resepsionis</title>
    <style>
        th,td{
...
<body>
    <div style="text-align: center;font-size:30px;font-weight:bold;color:#130f40;text-transform:uppercase" >Data resepsionis</div>
