...
class TamuExport implements FromQuery, WithHeadings, WithCustomStartCell, WithStyles,WithColumnWidths,WithMapping,ShouldAutoSize
{
    protected $tamu;

    public function query()
    {
        $this->tamu = Tamu::query()->get();
        return Tamu::query();
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // tittle
        $sheet->mergeCells("B4:H4")->setCellValue("B4","Data Tamu");
