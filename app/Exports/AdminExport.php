...
class AdminExport implements FromQuery, WithHeadings, WithCustomStartCell, WithStyles,WithColumnWidths,WithMapping,ShouldAutoSize
{
    protected $admin;

    public function query()
    {
        $this->admin = Admin::query()->get();
        return Admin::query();
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // tittle
        $sheet->mergeCells("B4:D4")->setCellValue("B4","Data admin");
