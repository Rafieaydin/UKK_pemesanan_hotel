...
class FhotelExport implements FromQuery, WithHeadings, WithCustomStartCell, WithStyles,WithColumnWidths,WithMapping,ShouldAutoSize
{
    protected $fhotel;

    public function query()
    {
        $this->fhotel = FasilitasHotel::query()->get();
        return FasilitasHotel::query();
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('D8:' . $highestCol . $highestRow)->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_LEFT);

        // tittle
        $sheet->mergeCells("B4:D4")->setCellValue("B4","Fasilitas Hotel");
